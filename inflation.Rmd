...
usethis::use_git_config(
  user.name = "hermannsiebel", # <-- change to your name
  user.email = "hermann.siebel@gmx.de", # <-- and your email
  init.defaultBranch = "main") # <-- not necessary but kinder than 'master'

usethis::use_git()

usethis::create_github_token(description = "Token for Repro Workshop 2025 3")
